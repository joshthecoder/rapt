...
import {drawGoldenCog} from '../util/cog';
import Vector from '../util/vector';
import {STAT_NUM_COGS} from '../world/gamestate';

const GOLDEN_COG_RADIUS = 0.25;

export default class GoldenCog extends Enemy {
	constructor(center) {
		super(-1, 0);
	...
	draw(c) {
		var position = this.getCenter();
		drawGoldenCog(c, position.x, position.y, GOLDEN_COG_RADIUS, this.timeSinceStart);
	}
}
