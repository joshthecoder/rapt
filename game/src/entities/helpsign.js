import {Enemy, ENEMY_HELP_SIGN} from './enemy';

import AABB from '../collisions/aabb';
import {drawTextBox, gameScale} from '../game/game';
...
// on its own line.
export default class HelpSign extends Enemy {
	constructor(center, text, width) {
		super(Enemy.ENEMY_HELP_SIGN, 0);
