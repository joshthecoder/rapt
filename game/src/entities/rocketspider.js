import {ENEMY_ROCKET_SPIDER} from './enemy';
import Particle from './particle';
import RocketSpiderLegs from './rocketspiderlegs';
...
export default class RocketSpider extends SpawningEnemy {
	constructor(center, angle) {
		super(ENEMY_ROCKET_SPIDER, center.add(new Vector(0, 0.81 - SPIDER_LEGS_RADIUS + SPIDER_HEIGHT * 0.5)),
