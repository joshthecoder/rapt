...
import {GameState, GAME_IN_PLAY, GAME_WON, GAME_LOST} from '../world/gamestate';

export const gameScale = 50;
...
export class Game extends Screen {
	...
	draw(c) {
		// if (!useBackgroundCache) {  // uncomment if bring back the background cache.
